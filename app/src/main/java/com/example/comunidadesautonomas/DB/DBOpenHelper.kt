    ...
    override fun onCreate(sqLiteDatabase: SQLiteDatabase) {
        ...
        try {
            ...
            val consultation = ("CREATE TABLE ${ComunityContract.Companion.Insert.TABLENAME}"
                    + "(${ComunityContract.Companion.Insert.COLUMN_ID} INTEGER PRIMARY KEY" //Importante asi para que el id se autoincremente
            ...
            for (c in list) {
                db.execSQL(
                    "INSERT INTO $tablename( " +
                            ...
                            " VALUES (${c.flag},'${c.name}','${c.capital}',${c.inhabitants},${c.latitude},${c.longitude},${c.icon});"
                )
